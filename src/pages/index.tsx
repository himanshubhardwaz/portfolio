      ...
      <div className='max-w-[1240px] w-full mx-auto p-2 flex justify-center items-center h-full'>
        <div className='mt-12'>
          ...
          <p className='py-4  sm:max-w-[70%] m-auto text-lg'>
            I am a Skilled FullStack JavaScript Developer 🚀 from India. I am
            always working on some project or learning something new! I also
            enjoy playing fps games and am currently working hard to build my
            dream gaming setup.
          </p>
